<div class="ps-lg-3">
    <h4 class="title text-dark">
        India 1970 20 Paise Coin FAO Food For All
    </h4>
    ...
    <p>India 1970 20 Paise Coin FAO Food For All</p>
    ...
    <div class="row">
        ...
        <dd class="col-9">Copper</dd>

        <dt class="col-3">Weight</dt>
        <dd class="col-9">3.00 g</dd>

        <dt class="col-3">Number</dt>
        <dd class="col-9">N#8720</dd>
    </div>
